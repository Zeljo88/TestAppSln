...
namespace Phoenix.Services
{
    public class VMService : IVMService
    {
        ...
        public VMService(IAmazonEC2 client, IAmazonCloudFormation cfnClient, IAmazonS3 s3client, IAWSService awsService )
        {
            _client = client;
        ...
        public async Task<EC2Response> CreateVirtualMachine(string amiID)
        {

            var result = _awsService.CreateVMAsync(amiID);
        ...
        public Task<EC2Response> CreateVMAsync(string amiID)
        {
            throw new NotImplementedException();
        }
    }
